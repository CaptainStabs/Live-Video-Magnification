...
{  
    ...
    QValidator *validator1 = new QRegularExpressionValidator(rx1, 0);
    ...
    QValidator *validator2 = new QRegularExpressionValidator(rx2, 0);
    ...
    QValidator *validator3 = new QRegularExpressionValidator(rx3, 0);
    ...
    QValidator *validator4 = new QRegularExpressionValidator(rx4, 0);
    ui->resHEdit->setValidator(validator4);
    // fpsEdit input validation
    QRegularExpression rx5("^[0-9]{1,3}$"); // Integers 0 to 999
    QValidator *validator5 = new QRegularExpressionValidator(rx5, 0);
